  ...
  Private Sub FormP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub NouveauProjetToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NouveauProjetToolStripMenuItem.Click
        ...
        Select Case ProjectType
            Case "spa"
                FormProjet.LabelAttention.Text = "Attention! Un projet à conception sur base spaciale est en cours." & vbCrLf & "Si vous choisissez de continuer, toutes les données non enregistrées seront perdues."
                FormProjet.LabelAttention.TextAlign = ContentAlignment.TopLeft
            Case "tmpm"
                FormProjet.LabelAttention.Text = "Attention! Un projet à conception sur base temporelle est en cours." & vbCrLf & "Si vous choisissez de continuer, toutes les données non enregistrées seront perdues."
                FormProjet.LabelAttention.TextAlign = ContentAlignment.TopLeft
            Case "tmpa"
                FormProjet.LabelAttention.Text = "Attention! Un projet à conception sur base temporelle est en cours." & vbCrLf & "Si vous choisissez de continuer, toutes les données non enregistrées seront perdues."
                FormProjet.LabelAttention.TextAlign = ContentAlignment.TopLeft
        ...
        If FormProjet.ShowDialog = DialogResult.OK Then
            ...
            Else
                If FormProjet.RadioButtonTMPM.Checked = True Then
